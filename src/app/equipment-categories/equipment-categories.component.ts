...
export class EquipmentCategoriesComponent implements OnInit,OnDestroy {
  ...
  Create(){
      ...
      if(this.action == 'Add'){
        this.appService.postData('equipment-category/create',data).pipe(takeUntil(this.destroy$)).subscribe(res=>{
          var r:any=res;
      ...
      if(this.action == 'Edit'){
        this.appService.postData('equipment-category/update',data).pipe(takeUntil(this.destroy$)).subscribe(res=>{
          var r:any=res;
          $('#addUserBtn').html('Save');
          if(r.success){
            this.getList();
  ...
  getListFromServer(form:any){
    this.appService.postData('equipment-category/list',form).pipe(takeUntil(this.destroy$)).subscribe(res=>{
      var r:any=res;
  ...
  updateStatus(userID:string,status:string){
    const data = {};
    this.appService.putData('equipment-category/status/update/'+userID+'/'+status,data).pipe(takeUntil(this.destroy$)).subscribe(res=>{
      var r:any=res;
      this.getList();
    },error=>{
      this.toastr.error("Server Error","Error");
  ...
  getQuotation(id:number){
      ...
      this.appService.postData('equipment-category/get',data).pipe(takeUntil(this.destroy$)).subscribe(res=>{
        var r:any=res;
        if(r.success){

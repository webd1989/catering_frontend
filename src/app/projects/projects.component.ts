...
export class ProjectsComponent implements OnInit,OnDestroy {
  ...
  Create(){
    ...
    if(this.action == 'Add'){
      this.appService.postData('project/create',data).pipe(takeUntil(this.destroy$)).subscribe(res=>{
        var r:any=res;
    ...
    if(this.action == 'Edit'){
      this.appService.postData('project/update',data).pipe(takeUntil(this.destroy$)).subscribe(res=>{
        var r:any=res;
        $('#addUserBtn').html('Save');
        if(r.success){
          this.getList();
  ...
  getListFromServer(form:any){
    this.appService.postData('project/list',form).pipe(takeUntil(this.destroy$)).subscribe(res=>{
      var r:any=res;
  ...
  getUser(id:number){
    ...
    this.appService.postData('project/get',data).pipe(takeUntil(this.destroy$)).subscribe(res=>{
      var r:any=res;
      if(r.success){
  ...
  updateStatus(userID:string,status:string){
    const data = {};
    this.appService.putData('project/status/update/'+userID+'/'+status,data).pipe(takeUntil(this.destroy$)).subscribe(res=>{
      var r:any=res;
      this.getList();
    },error=>{
      this.toastr.error("Server Error","Error");

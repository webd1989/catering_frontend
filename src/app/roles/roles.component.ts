...
export class RolesComponent implements OnInit,OnDestroy {
  ...
  Create(){
      ...
      if(this.action == 'Add'){
        this.appService.postData('role/create',data).pipe(takeUntil(this.destroy$)).subscribe(res=>{
          var r:any=res;
      ...
      if(this.action == 'Edit'){
        this.appService.postData('role/update',data).pipe(takeUntil(this.destroy$)).subscribe(res=>{
          var r:any=res;
          $('#addUserBtn').html('Save');
          if(r.success){
            this.getList();
  ...
  getListFromServer(form:any){
    this.appService.postData('role/list',form).pipe(takeUntil(this.destroy$)).subscribe(res=>{
      var r:any=res;
  ...
  updateStatus(userID:string,status:string){
    const data = {};
    this.appService.putData('role/status/update/'+userID+'/'+status,data).pipe(takeUntil(this.destroy$)).subscribe(res=>{
      var r:any=res;
      this.getList();
    },error=>{
      this.toastr.error("Server Error","Error");
